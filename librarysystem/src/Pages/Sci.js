    ...
    <div className='login-page'>
      <div className='login'>
        ...
        <div className='kids-section'>
            <h1 className='kids-heading1'>SCI & Fantacy</h1>
            <br></br><br></br><br></br><br></br>
            <div class="row row-cols-1 row-cols-md-5 g-5">
  <div class="col">
    <div class="">
      <div class="kids1  card-body">
        <img src={sci} width={180} height={220}/>

        <div className='book-content'>
        <a href="#" className='book-heading1'>2001 : A Space Odyssey</a><br></br>
        <a href="#" className='book-heading1'>By Arthur C Clarke</a>
