    ...
    <div className='login-page'>
      <div className='login'>
        ...
        <div className='kids-section'>
            <h1 className='kids-heading1'>Romance</h1>
            <br></br><br></br><br></br><br></br>
            <div class="row row-cols-1 row-cols-md-5 g-5">
  <div class="col">
    <div class="">
      <div class="kids1  card-body">
        <img src={romance} width={180} height={220}/>

        <div className='book-content'>
        <a href="#" className='book-heading1'>It Ends With Us</a><br></br>
        <a href="#" className='book-heading1'>by Colleen Hoover</a>
        </div>
      </div>
    </div>
  </div>
