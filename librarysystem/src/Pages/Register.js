        ...
        <div className='account'>
            ...
            <div className='account-content'>
                <form>
                   ...
                   <b><p className='email'>NIC*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<input type="text" class="mobiless form-control w-50" id="exampleFormControlInput1" value={nic} onChange={(e) => setNic(e.target.value)} /></p></b>
                   <b><p className='email'>Username*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<input type="text" class="user form-control w-50" id="exampleFormControlInput1"  value={username} onChange={(e) => setUsername(e.target.value)}/></p></b>
                   <b><p className='email'>Password*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<input type="password" class="user form-control w-50" id="exampleFormControlInput1" value={password} onChange={(e) => setPassword(e.target.value)}/></p></b>
                   <b><p className='email'>Confirm Password*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<input type="password" class="user form-control w-50" id="exampleFormControlInput1" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} /></p></b>
                ...
                <small className="confirm text-danger alert-dismissible">Passwords do not match.</small> 
                   ...
                   <div className='button'>
                      <button type="submit"  onClick={handleRegister} disabled={!agreed}>Register</button>
                   </div>
                </form>
                {successMessage && 
